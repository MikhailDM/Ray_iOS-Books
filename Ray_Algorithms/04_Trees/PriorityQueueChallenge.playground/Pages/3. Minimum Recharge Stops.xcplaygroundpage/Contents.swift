/*
 ...
 An electric car has an infinite charge capacity.
 One charge capacity is equivalent to one mile.
 The list of stations is sorted by distance from the start location:
